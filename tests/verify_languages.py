...
async def run():
    async with async_playwright() as p:
        ...
        print(f"🌍 Navigating to ES: {url_es}...")
        try:
            await page.goto(url_es, timeout=10000)
        except Exception as e:
            print(f"❌ Could not connect to {url_es}. Is preview running?")
            await browser.close()
            return
        ...
        print("👆 Looking for language switcher...")
        ...
        try:
            ...
            await en_link.click()
             ...
             print("❌ Could not find 'English' link. Checking page content for debugging...")
        ...
        if "/en/" in current_url:
            print("✅ SUCCESS: Switched to English version.")
        else:
            print("❌ FAILURE: URL does not contain '/en/'.")
        ...
        print("🔄 Switching back to Spanish...")
        ...
        try:
            es_link = await page.wait_for_selector("a:text('Español')", timeout=5000)
            await es_link.click()
        except:
             print("❌ Could not find 'Español' link.")
        ...
        if "/es/" in final_url:
             print("✅ SUCCESS: Switched back to Spanish.")
        else:
             print("❌ FAILURE: URL did not return to '/es/'.")
