...
function injectPDFButton(languages, rootPrefix) {
    ...
    if (sidebar) {
        ...
        const pdfFilename = `DocumentacionTFGenTiemposDeIA_${lang}.pdf`;
...
function injectGiscusComments() {
    ...
    const defaultConfig = {
        ...
        allowedPaths: [
            ...
            "es/02_documentacion/memoria/introduccion.html",
            "es/02_documentacion/memoria/objeto_objetivos.html",
            "es/02_documentacion/memoria/antecedentes.html",
            "es/02_documentacion/memoria/metodos_herramientas.html",
            "es/02_documentacion/memoria/requisitos_alcance.html",
            "es/02_documentacion/memoria/solucion_propuesta.html",
            "es/02_documentacion/memoria/riesgos_gestion.html",
            "es/02_documentacion/memoria/conclusiones.html",
            "es/02_documentacion/anexos.html",
            "es/02_documentacion/anexos/a1_especificaciones.html",
            "es/02_documentacion/anexos/a2_analisis_diseno.html",
            "es/02_documentacion/anexos/a3_estimacion.html",
            "es/02_documentacion/anexos/a4_seguridad.html",
            "es/02_documentacion/anexos/a5_otros.html",
