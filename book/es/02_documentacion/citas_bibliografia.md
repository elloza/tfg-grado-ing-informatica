...
- Referencias que aparecen en bibliografía pero no están citadas.
- Citas en el texto que no aparecen en bibliografía.
- Fechas, autores o títulos incompletos.
- Cambios de estilo aplicados a medias.
- URLs sin fecha de consulta.
- Bibliografías inconsistentes entre Word, PDF y LaTeX.

## Flujo mínimo recomendado

1. Instala un gestor bibliográfico.
2. Captura fuentes desde el navegador.
3. Revisa los metadatos antes de aceptar la referencia.
4. Organiza las fuentes por carpetas o colecciones del TFG.
5. Inserta citas desde el plugin de Word o exporta BibTeX para LaTeX/Overleaf.
6. Genera la bibliografía automáticamente.
7. Revisa al final que toda cita tiene entrada y toda entrada está citada.
...
El punto crítico no es pulsar "importar". El punto crítico es revisar. Muchos importadores confunden mayúsculas, páginas web, nombres de conferencia o autores corporativos.

## Zotero como alternativa
